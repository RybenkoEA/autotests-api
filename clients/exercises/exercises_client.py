...
from clients.exercises.exercises_schema import ExercisesClientRequestSchema,CreateExercisesRequestSchema, \
    CreateExercisesResponseSchema, UpdateExercisesRequestSchema, UpdateExerciseResponseSchema, \
    GetExerciseResponseSchema, GetExercisesResponseSchema, GetExercisesQuerySchema
...
class ExercisesClient(APIClient):
    ...
    """
    def get_exercises_api(self, query: ExercisesClientRequestSchema) -> Response:
        """
